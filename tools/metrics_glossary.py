...
("Dispersion and correlation", "bootstrap.fit_dispersion → artifacts/r_lookup.json, rho.json",
 ...
 "is worth, and how confident the agent may be.", [
  ...
  ("rho", "rate",
   ...
   "**0.2436.** A changed prior invalidates it.", "GATE — mirrored into config"),
  ("mean_forced_hours_per_episode", "hours",
   "Average number of hours per episode that carry forced (randomised) prices. "
   "**5.909.** The cluster size in the design effect.", "GATE — mirrored into config"),
  ("deff", "ratio",
   "Design effect `1 + (m − 1)·ρ` = **2.196**. Divides Fisher information before it "
   "is compared to the learning threshold: 5.909 correlated hours carry the "
   "information of about 2.69 independent ones.", "every posterior update"),
 ]),
