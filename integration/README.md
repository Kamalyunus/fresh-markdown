...
| `src/` | the owner | the engine: the hourly path's modules, one file per repository module. `MANIFEST.json` says which are verbatim copies and which this folder edits, and why |
