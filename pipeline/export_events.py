"""pipeline.export_events -- dump the event log to tables for the warehouse.
...
Run: python3 -m pipeline.export_events [--out-dir exports] [--since YYYY-MM-DD]
"""
...
def main():
    ap = argparse.ArgumentParser(prog="pipeline.export_events")
